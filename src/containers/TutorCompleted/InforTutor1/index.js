...
import { getListTutorCompleted } from "../../../actions";
import Layout from "../../../components/Layout";

InforTutor1.propTypes = {};

function InforTutor1(props) {
  ...
  const editedTutor = useSelector((state) => {
    const a = state.tutors.listTutorCompleted;
    const foundTutor = a?.find((x) => x.id === +tutorId);
    // console.log({ tutors: state.tutors, tutorId, foundTutor });
    return foundTutor;
  });

  // const v = useSelector((state) => state.tutors.listTutorCompleted);
