...
import { getListPost, getListPostMustVerify } from "../../../actions";
import Layout from "../../../components/Layout";

InforPost1.propTypes = {};

function InforPost1(props) {
  ...
  const editedPost = useSelector((state) => {
    const foundPost = state.posts.listPostMustVerify.find((x) => x.id === +postId);
    // console.log({ posts: state.posts, postId, foundPost });
    return foundPost;
  });

  // const v = useSelector((state) => state.posts.listPostMustVerify);
